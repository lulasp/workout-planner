...
import { addBodystate } from '../../actions/profile';

export const AddBodystate = ({ addBodystate, history }) => {
...
AddBodystate.propTypes = {
    addBodystate: PropTypes.func.isRequired
}

export default connect(null, { addBodystate })(withRouter(AddBodystate));
